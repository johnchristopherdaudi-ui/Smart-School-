...
from smart_school.tests.factory import (
    ACCOUNTANT, HEADMASTER, PARENT_1, TEACHER_1, SchoolTestCase, as_user, make_user, render,
)
...
class TestPortalPages(SchoolTestCase):
    ...
    def test_every_page_renders_on_the_base_template(self):
        pages = [("parent-portal", {}), ("parent-portal/student", {"student": self.s["a"]}),
                 ("parent-portal/results", {"student": self.s["a"]}), ("parent-portal/fees", {"student": self.s["a"]}),
                 ("parent-portal/discipline", {"student": self.s["a"]}), ("parent-portal/announcements", {}),
...
class TestWorkspaces(SchoolTestCase):
    ...
    def test_workspace_pages_load(self):
        ...
        cards = [c.get("number_card_name") if hasattr(c, "get") else c.number_card_name for c in page["number_cards"]["items"]]
    ...
    def test_default_workspace_per_role(self):
        ...
        expected = {HEADMASTER: "Headmaster", ACCOUNTANT: "Finance", TEACHER_1: "Academics", "_test.own@example.com": "Tools"}
